...
public class Threshold_Learning {
	...
	public void script(String dataname,String base,String vecfile,int time) throws IOException{
		folderPath = "results_"+time+"/"; //Current period folder
		...
		double threshold_before[]=new double[ntopics];
...
//            	System.out.println(1/(1+Math.pow (Math.E,-eps)));
    ...
    private String GetBitermMaxSimi(String word) {
        ...
        for (int i = 0; i < seedList.size(); i++) {
            seedarray = seedList.get(i); //The seed words of category i
            simivalue = 0;
