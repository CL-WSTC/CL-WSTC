...
public class SimiBTM_withDelay {
    ...
    public SimiBTM_withDelay(String pathToCorpus, String pathToSeed, String pathToSimi, int inNumTopics,
                   double inAlpha, double inBeta, int inNumIterations, int inTopWords,
                   String inExpName,double hmin,double[] rejectThreshold,int time,String vecfile, int seed_limit)
            throws IOException
    {
        alpha = inAlpha;
        beta = inBeta;
...
//                                    * wordsimimap.get(word2)[topic_id]
            ...
            throws IOException
    {
        ...
        try {
        	stbtm = new SimiBTM_withDelay(docanme_accept, seedPath, wordsiminame,numTopics,
             		50/numTopics + 1, 0.1, 200, 30,"accept"+"_"+time+"_SeedBTM",0.0001,
             		threshold_acc,time,vecfile,seed_limit);
            stbtm.inference2();   
        } catch (IOException e) {
            e.printStackTrace();
        }
