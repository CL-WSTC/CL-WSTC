...
def main():
    ...
    parser.add_argument('--dataset_dir', default='datasets/your_dataset/',
    ...
    parser.add_argument('--match_threshold', type=int, default=5,
    ...
    parser.add_argument('--self_train_epochs', type=float, default=2,
